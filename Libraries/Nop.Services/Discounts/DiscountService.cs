...
namespace Nop.Services.Discounts
{
    ...
    public partial class DiscountService : IDiscountService
    {
        ...
        public virtual IList<Discount> GetAllowedDiscounts(Product product,
            Customer customer)
        {
            ...
            if (product.HasDiscountsApplied)
            {
                ...
                {
                    if (IsDiscountValid(discount, customer) &&
            ...
            if (GetAllDiscounts(DiscountType.AssignedToCategories).Any())
            {
